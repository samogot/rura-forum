...
$(function () {
    $('.list-group.checked-list-box .list-group-item').each(function () {
        ...
        var $widget = $(this),
            ...
            color = ($widget.data('color') ? $widget.data('color') : "blue"),
...
/*
    if (!($('.topic-pagination a, .forum-pagination a').hasClass('no-btn'))){
        $('.topic-pagination strong, .forum-pagination strong').attr('class','btn btn-blue btn-sm disabled');
    };
*/
    $('.page-sep').remove();
    $('.pm-to a:not(.btn)').attr('class','btn btn-default btn-sm');
    
    $('.btn-fix a').addClass('btn btn-blue btn-sm');
